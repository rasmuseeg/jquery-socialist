(($, window, document, undefined) => {
  $.fn.socialist = function (method) {
    ...
    var helpers = {
      ...
      networkDefs: {
        rss: {
          url: "http://ajax.googleapis.com/ajax/services/feed/load?v=1.0&num=|num|&callback=?&q=|id|", dataType: "json", parser: {
            name: "rss",
        ...
        facebook: {
          url: 'http://graph.facebook.com/|id|/photos?limit=|num|', img: '', dataType: 'json', parser: {
            name: "facebook",
        ...
        youtube: {
          url: 'https://gdata.youtube.com/feeds/api/users/|id|/uploads?alt=json&max-results=|num|', dataType: "jsonp", img: '', parser: {
            name: "youtube",
        ...
        twitter: {
          url: 'https://api.twitter.com/1/statuses/user_timeline.json?include_entities=true&include_rts=true&screen_name=|id|&count=|num|', dataType: "jsonp", img: '', parser: {
            name: "twitter",
        ...
        linkedin: {
          url: 'http://www.linkedin.com/company/|id|/', img: '', dataType: "text", parser: {
            name: "linkedin",
        ...
        tumblr: {
          url: 'http://|id|.tumblr.com/api/read/json?callback=helpers.cb&num=|num|', dataType: "jsonp", parser: {
            name: "tumblr",
        ...
        flickr: {
          url: 'http://api.flickr.com/services/rest/?extras=tags%2Cdescription%2Cdate_upload&nojsoncallback=1&api_key=|apiKey|&method=flickr.people.getPublicPhotos&format=json&per_page=|num|&user_id=|id|', dataType: 'json', parser: {
            name: "flickr",
        ...
        googleplus: {
          url: 'https://plus.google.com/|id|', dataType: 'text', parser: {
            name: "google",
        ...
        pinterest: {
          url: 'http://pinterest.com/|id|/', dataType: "text", parser: {
            name: "pinterest",
        ...
        quora: {
          url: 'http://www.quora.com/|id|/feed/', dataType: "text", parser: {
            name: "quora",
        ...
        instagram: {
          url: "https://api.instagram.com/v1/tags/|id|/media/recent?client_id=|apiKey|", dataType: "jsonp", parser: {
            name: "instagram",
            resultsSelector: "data.data",
            heading: "Instagr.am",
        ...
        craigslist: {
          url: "http://|areaName|.craigslist.org/|id|", dataType: "text", parser: {
            name: "craigslist",
        ...
        vimeo: {
          url: 'http://vimeo.com/api/v2/|id|/videos.json', dataType: "jsonp", parser: {
            name: "vimeo",
            resultsSelector: "data",
            heading: "Vimeo",
            headingSelector: "item.title",
      ...
      timeAgo: function (date_str) {
        ...
        var time:string = ('' + date_str).replace(/-/g, "/").replace(/[TZ]/g, " ").replace(/^\s\s*/, '').replace(/\s\s*$/, '');
        if (time.substr(time.length - 4, 1) == ".") time = time.substr(0, time.length - 4);
        var seconds: number = (<any>new Date() - <any>new Date(time)) / 1000;
